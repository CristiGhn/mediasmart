...
9. Cache id is calculated via cached + page. So the content is unique on each page.

Restart apps after code changes
Client React refreshes each time the file is changed.
On backend for development I used instead of npm start nodemon ./bin/www 
